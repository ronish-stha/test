    ...
    <div class="sidebar-wrapper">
        ...
        <ul class="nav">
            @if (Auth::user()->verified)
                <li {{ Helper::getActiveClass('seller/dashboard') }}>
                    <a href="{{ route('seller.dashboard') }}">
                        <i class="material-icons">dashboard</i>
                        <p>Dashboard</p>
                    </a>
                </li>
                <li {{ Helper::getActiveClass('seller/seller-product*') }}>
                    <a href="{{ route('seller-product.index') }}">
                        <i class="material-icons">sports_bar</i>
                        <p>Products</p>
                    </a>
                </li>
                <li {{ Helper::getActiveClass('seller/seller-order*') }}>
            ...
            @else
                <li {{ Helper::getActiveClass('seller/verify') }}>
