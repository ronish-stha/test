            ...
            <div class="row">
                <div class="col-lg-3 col-sm-12">
                    ...
                    <ul style="padding-left: 30px">
                        ...
                        <li><a href="#" data-toggle="modal" data-target="#editAddressModal">Change Delivery Address</a>
                        </li>
                    </ul>
                            ...
                            @foreach ($order->orderDetails as $orderDetail)
                                <tr>
                                    <td class="text-center">
                                        @if ($orderDetail->productVariant->parentVolume->image)
                                            <img class="thumbnail img-responsive"
                                                 src="{{URL::asset($orderDetail->productVariant->parentVolume->image) }}"
                                                 alt="" style="height:110px; width:100px; display: block;
                                                             margin-left: auto;
                                                             margin-right: auto;"
                                            />
                                        @else
                                            @if ($orderDetail->productVariant->product->image)
                                                <img class="thumbnail img-responsive"
                                                     src="{{URL::asset($orderDetail->productVariant->product->image) }}"
                                                     alt="" style="height:110px; width:100px; display: block;
                                                             margin-left: auto;
                                                             margin-right: auto;"
                                                />
                                    ...
                                    <th class="text-center">Rs. {{ $orderDetail->total }}</th>
                                </tr>
                            @endforeach
                            <tr>
                                <td></td>
